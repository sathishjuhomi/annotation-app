...
async def send_invitation_email(email_to: str, team_name: str, token: str) -> None:
    valid_hours = PASSWORD_REST_TOKEN_EXPIRY / 60
    link = f"{SERVER_HOST}/api/v1/accept-invitation?token={token}&id={team_name}&email={email_to}"
