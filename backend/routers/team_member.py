...
from backend.schemas.response.team_member import AcceptDeclineInvitationSchema
...
@team_member_router.patch("/teams/team-members/accept-invitation",
                          response_model=AcceptDeclineInvitationSchema | DetailSchema)
...
@team_member_router.patch("/teams/team-members/decline-invitation",
                          response_model=AcceptDeclineInvitationSchema)
async def decline_invitation(
    ...
    return {"detail": f"{team_member_detail.team.team_name} team invitation declined", "team_member": response}
